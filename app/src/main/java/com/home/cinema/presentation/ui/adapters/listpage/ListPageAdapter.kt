...
class ListPageAdapter(
...
) : PagingDataAdapter<Movie, ListPageMovieViewHolder>(ListPageMovieDiffUtilCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListPageMovieViewHolder {
        return ListPageMovieViewHolder(
    ...
    override fun onBindViewHolder(holder: ListPageMovieViewHolder, position: Int) {
...
class ListPageMovieViewHolder(val binding: MoviesItemMovieBinding) :
    RecyclerView.ViewHolder(binding.root)

class ListPageMovieDiffUtilCallback : DiffUtil.ItemCallback<Movie>() {
